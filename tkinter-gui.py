...
button1 = tk.Button(root, text='Get the Square Root', command=getSquareRoot)
...
def getSquareRoot ():
    ...
    if x1 == "":
        messagebox.showinfo("Title", "PLease type a numerical value")
    else:
...
label1= tk.Label(root, text='Type your Number 1:')
...
label2= tk.Label(root, text='Type your Number 2:')
label2.config(font=('helvetica', 10))
